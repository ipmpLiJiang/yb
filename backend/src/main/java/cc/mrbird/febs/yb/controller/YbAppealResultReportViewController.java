...
//        return getDataTable(this.iYbAppealResultReportViewService.findAppealResultReportViews(request, ybAppealResultReportView,keyField,true));
    ...
    public void reportExcel(YbAppealResultReportView ybAppealResultReportView, HttpServletResponse response, String keyField) throws FebsException {
        try {
...
//                }
    ...
    public void reportUserExcel(YbAppealResultReportView ybAppealResultReportView, HttpServletResponse response, String keyField) throws FebsException {
        try {
            User currentUser = FebsUtil.getCurrentUser();
            ybAppealResultReportView.setArDoctorCode(currentUser.getUsername());
...
//                }
    ...
    @PostMapping("reportConfExcel")
    @RequiresPermissions("ybAppealResultReportView:exportConfData")
    public void reportConfExcel(YbAppealResultReportView ybAppealResultReportView, HttpServletResponse response, String keyField) throws FebsException {
        try {
            User currentUser = FebsUtil.getCurrentUser();
            List<YbAppealResultReportView> appealResultReportList = this.iYbAppealResultReportViewService.findAppealResultReportConfLists(ybAppealResultReportView, keyField,currentUser.getUsername());
