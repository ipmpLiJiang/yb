...
public class PDFUtil {
    ...
    public static void main(String[] args) {
        ...
        PDFUtil pdfUtil = new PDFUtil("D:\\work\\java\\html", name);
        Map<String, Object> paraMap = new HashMap<String, Object>();
        paraMap.put("constructionName", "1231");
        paraMap.put("empName", "1232");
        paraMap.put("idCode", "1233");
        paraMap.put("teamName", "1234");
        paraMap.put("projectName", "1235");
        try {
    ...
    private void createPDFFile(String htmlStr, OutputStream os) throws Exception {
        ...
        try {
            ...
            // step 3
            document.open();
            FontFactoryImp provider = new FontFactoryImp();
     ...
     * 字体
     */
    private class FontProviderFontProvider extends XMLWorkerFontProvider {
