...
export default {
  ...
  methods: {
    ...
    setFormValues ({ ...ybChsManageHistory }) {
      this.ybChsManageHistory = ybChsManageHistory
      this.fetch()
      setTimeout(() => {
    ...
    fetch (params = {}) {
      params.applyDateStr = this.ybChsManageHistory.applyDateStr
      params.applyDataId = this.ybChsManageHistory.applyDataId
      this.loading = true
      if (this.paginationInfo) {
