...
export default {
  ...
  methods: {
    ...
    setFields () {
      let values = this.form.getFieldsValue(['zymzType', 'plType', 'isRule', 'ruleName', 'isProject', 'projectName', 'dksId', 'dksName', 'doctorCodeTo', 'doctorNameTo', 'dksIdTo', 'dksNameTo', 'deptType', 'personType'])
