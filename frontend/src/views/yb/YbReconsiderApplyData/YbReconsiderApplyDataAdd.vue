  ...
  methods: {
    ...
    handleSubmit () {
      this.form.validateFields((err, values) => {
        if (!err) {
          this.setFields()
          this.$post('ybReconsiderApplyData', {
            ...this.ybReconsiderApplyData
          }).then(() => {
            this.reset()
            this.$emit('success')
