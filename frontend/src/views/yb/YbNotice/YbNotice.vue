...
export default {
  ...
  methods: {
    ...
    add () {
      ...
      this.$refs.ybNoticeEdit.setFormValues(null, this.user.areaType.value, this.selectAdminTypeDataSource)
    },
    handleEditSuccess () {
      this.editVisiable = false
      this.search()
    ...
    edit (record) {
      this.$refs.ybNoticeEdit.setFormValues(record, this.user.areaType.value, this.selectAdminTypeDataSource)
      this.editVisiable = true
    },
    del (record) {
      let that = this
