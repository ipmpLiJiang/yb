...
export default {
  ...
  methods: {
    ...
    setFields () {
      let values = this.form.getFieldsValue(['applyDataId', 'verifyId', 'manageId', 'doctorCode', 'doctorName', 'deptCode', 'deptName', 'operateReason', 'operateDate', 'currencyField'])
      if (typeof values !== 'undefined') {
        Object.keys(values).forEach(_key => { this.ybAppealResult[_key] = values[_key] })
      }
    }
  }
}
