...
export default {
  ...
  methods: {
    ...
    fetch (params = {}) {
      this.dataSource = []
      params.billNo = this.ybInpatientfeesModule.billNo
      params.transNo = this.ybInpatientfeesModule.serialNo
      params.itemCode = this.ybInpatientfeesModule.projectCode
      this.loading = true
      if (this.paginationInfo) {
