...
// import YbDrgManageHistory from '../ybFunModule/YbDrgManageHistoryModule'
...
export default {
  ...
  components: {
    YbDrgManageLook, YbDrgManageAccept, YbDrgManageRefused, YbDrgManageReject, YbDrgManageStayed, YbDrgManageCompleted, YbDrgManageOverdue, YbDrgManageUpload},
  data () {
    return {
      monthFormat: 'YYYY-MM',
